...
filepath = os.path.join(os.path.dirname(datasets['MEG_perampanel']), 'meg_perampanel_metadata.csv')
filepath_pkl = os.path.join(os.path.dirname(datasets['MEG_perampanel']), 'meg_perampanel_metadata.pkl')
...
pattern = r'/home/yorguin/scratch/data/MEG_perampanel/meg_data/PMP_%session%_%subject%_%number%.mat'
