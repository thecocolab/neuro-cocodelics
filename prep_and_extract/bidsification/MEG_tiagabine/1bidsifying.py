...
filepath = os.path.join(os.path.dirname(datasets['MEG_tiagabine']), 'MEG_tiagabine_metadata.csv')
filepath_pkl = os.path.join(os.path.dirname(datasets['MEG_tiagabine']), 'MEG_tiagabine_metadata.pkl')
...
pattern = r'/home/yorguin/scratch/data/MEG_tiagabine/meg_data/TGB_%session%_%subject%_%number%.mat'
...
BIDS_ROOT = '/home/yorguin/scratch/data/MEG_tiagabine/meg_data_BIDS'
