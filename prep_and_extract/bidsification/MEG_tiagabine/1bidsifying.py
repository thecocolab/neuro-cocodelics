...
OUTPUT_PATH = '/home/yorguin/projects/rrg-kjerbi/shared/neuro-cocodelics/bids/MEG_tiagabine/'
...
filepath = os.path.join(OUTPUT_PATH, 'MEG_tiagabine_metadata.csv')
filepath_pkl = os.path.join(OUTPUT_PATH, 'MEG_tiagabine_metadata.pkl')
...
if not os.path.exists(filepath):
    ...
    df = pd.DataFrame.from_records(metadatas_dict['MEG_tiagabine'])
...
# '/home/yorguin/scratch/data/MEG_tiagabine/meg_data/PMP_PMP_020414_50.mat'
pattern = r'/home/yorguin/projects/def-kjerbi/data/MEG_tiagabine/meg_data/TGB_%session%_%subject%_%number%.mat'
...
df_bids['session_bids'] = df_bids['session'].apply(lambda x: 'placebo' if x == 'PLA' else 'tiagabine')
...
BIDS_ROOT = '/home/yorguin/projects/rrg-kjerbi/shared/neuro-cocodelics/bids/MEG_tiagabine'
