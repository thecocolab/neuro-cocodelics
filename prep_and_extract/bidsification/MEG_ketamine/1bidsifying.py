...
filepath = os.path.join(os.path.dirname(datasets['MEG_ketamine']), 'MEG_ketamine_metadata.csv')
filepath_pkl = os.path.join(os.path.dirname(datasets['MEG_ketamine']), 'MEG_ketamine_metadata.pkl')
...
pattern = r'/home/yorguin/scratch/data/MEG_ketamine/meg_data/KET_%session%_%subject%_%number%.mat'
...
BIDS_ROOT = '/home/yorguin/scratch/data/MEG_ketamine/meg_data_BIDS'
