...
ID_file = os.path.join(os.path.dirname(__file__), 'IDs.xlsx')
...
SOURCE_PATH = "/home/yorguin/scratch/real_scratch/data/MEG_LSDV2/meg_data"
...
pattern = r'/home/yorguin/scratch/real_scratch/data/MEG_LSDV2/meg_data/%subjectNumber%_LSD_%session%_%task%.ds'
...
def simplify_path(path):
    ...
    base_dir = '/home/yorguin/scratch/real_scratch/data/MEG_LSDV2/meg_data/'
...
df_megs.to_csv(os.path.join(os.path.dirname(__file__), 'meg_bids.csv'), index=False)